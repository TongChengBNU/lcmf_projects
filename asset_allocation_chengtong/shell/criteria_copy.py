...
df_CashPortfolio = pd.read_csv(r'E:\1-Career\lcmf\Projects\Ranking\statistic\ra_pool_cash.csv', parse_dates=['ra_date'], index_col=['ra_date'])
# ra_pool_nav 11310102
df_Steady = pd.read_csv(r'E:\1-Career\lcmf\Projects\Ranking\statistic\ra_portfolio_nav.csv', parse_dates=['ra_date'], index_col=['ra_date'])[['ra_nav']]
...
bank_nav = pd.read_excel(r'E:\1-Career\lcmf\Projects\Ranking\statistic\银行理财产品预期年收益率人民币.xls', parse_dates=['date'])
...
dingkai = pd.read_excel(r'E:\1-Career\lcmf\Projects\Ranking\statistic\定开债基 成分股.xlsx')
