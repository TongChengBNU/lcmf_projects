...
def low_rank_bond_fund(ctx):
    ...
    Fund_high_credit_rating = chinamutualfundbondportfolio_rating_high_credit_rating_selected_Assistant_[(chinamutualfundbondportfolio_rating_high_credit_rating_selected_Assistant_ > 0) | (chinamutualfundbondportfolio_rating_high_credit_rating_selected_Assistant_ < 100)]
    Fund_lower_credit_rating = chinamutualfundbondportfolio_rating_lower_credit_rating_selected_Assistant_[(chinamutualfundbondportfolio_rating_lower_credit_rating_selected_Assistant_ > 10) | (chinamutualfundbondportfolio_rating_lower_credit_rating_selected_Assistant_ < 30)]
    ...
    #    Equally weighted L-S strategy at 30% rank quantile of portfolio 
        ...
        delete_top_number = min(5, max(stock_return.shape[1] - 6, 0) )
