...
#
# figure1_data, figure2_data = ins1.align_nominal_2111()
# figure1_data.reset_index(inplace=True)
# fig = px.line(figure1_data, x='TRADE_DT', y='hushen300DividendRate-bond3_5YTM')
# fig.show()
